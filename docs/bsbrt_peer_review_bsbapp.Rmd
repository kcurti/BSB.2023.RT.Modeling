...
#Comparing ASAP with standard WHAM and Multi-WHAM

.pull-left[
* Based on data used in last management track 
  * Time series of observations not updated
  * Use previous fleet definitions (Trawl and Non-Trawl).
* Compared
  * Management track ASAP 
...
* 6: Add NEAMAP
* 7: Update remaining spring state indices (added VAST as well but didn’t turn them on)
* 8: Rec CPA and both spring and fall VAST
* 9: Rec CPA and VAST spring only (also a combined stock run that matches the single stock results. This combined run will be used for later runs.)
...
* 6: Add NEAMAP
* `r colorize("7: Update remaining spring state indices (added VAST as well but didn’t turn them on)", "red")`
* `r colorize("8: Rec CPA and both spring and fall VAST", "red")`
...
# Bridge runs 7, 8, and 9

.pull-left[
```{r echo = FALSE, out.width="100%", fig.align="center", fig.cap = "North"}
knitr::include_graphics(here::here("Bridge.Runs","Comparison_Figures", "Runs7-9.north.F.png"))
```
]
.pull-right[
```{r echo = FALSE, out.width="100%", fig.align="center", fig.cap = "South"}
knitr::include_graphics(here::here("Bridge.Runs","Comparison_Figures", "Runs7-9.south.F.png"))
```
]
---
...
.pull-left[
```{r echo = FALSE, out.width="100%", fig.align="center", fig.cap = "North"}
knitr::include_graphics(here::here("Bridge.Runs","Comparison_Figures", "Runs7-9.north.SSB.png"))
```
]
.pull-right[
```{r echo = FALSE, out.width="100%", fig.align="center", fig.cap = "South"}
knitr::include_graphics(here::here("Bridge.Runs","Comparison_Figures", "Runs7-9.south.SSB.png"))
```
]
---
...
.pull-left[
```{r echo = FALSE, out.width="100%", fig.align="center", fig.cap = "North"}
knitr::include_graphics(here::here("Bridge.Runs","Comparison_Figures", "Runs7-9.north.Rect.png"))
```
]
.pull-right[
```{r echo = FALSE, out.width="100%", fig.align="center", fig.cap = "South"}
knitr::include_graphics(here::here("Bridge.Runs","Comparison_Figures", "Runs7-9.south.Rect.png"))
```
]
---
...
* Run 34 relaxed estimated scalar for uncertainty in the Recreational CPA indices
