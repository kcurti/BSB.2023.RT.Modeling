...
```{r jitter-res-1, echo = FALSE, out.width="80%", fig.align="center", fig.cap = "Marginal negative log-likelihood and maximum absolute value of gradients for each of 16 jitter iterations."}
