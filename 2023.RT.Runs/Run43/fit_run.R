...
F1_positions=c(1,34,67,100)
F1_pars <- c(pars$F_pars[1],pars$F_pars[34],pars$F_pars[67],pars$F_pars[100])
F1_sd <- c(sd$F_pars[1],sd$F_pars[34],sd$F_pars[67],sd$F_pars[100])

temp$par <- Run34$parList
for(i in F1_positions) temp$par$F_pars[i]<-log(ci(pars$F_pars[i],sd$F_pars[i], type = "exp")[3])
