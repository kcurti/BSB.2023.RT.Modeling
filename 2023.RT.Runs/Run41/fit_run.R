...
#Function from par_tables_fn to help pull CI for estimated parameters
...
# }
# F1_pars <- c(pars$F_pars[1],pars$F_pars[34],pars$F_pars[67],pars$F_pars[99])
# F1_sd <- c(sd$F_pars[1],sd$F_pars[34],sd$F_pars[67],sd$F_pars[99])
# ci(pars$F_pars[1],sd$F_pars[1], type = "exp")[2]
# ci(pars$F_pars[34],sd$F_pars[34], type = "exp")[2]
# ci(pars$F_pars[67],sd$F_pars[67], type = "exp")[2]
# ci(pars$F_pars[99],sd$F_pars[99], type = "exp")[2]

temp$par <- Run34$parList
# temp$par$F_pars
temp$map$F_pars <- as.factor(c(NA,c(1:32),NA,c(33:64),NA,c(65:96),NA,c(97:128)))
