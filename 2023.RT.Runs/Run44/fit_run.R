...
library(here)
# asap <- read_asap3_dat(c(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "NORTH.BRIDGE.RUN.7.DAT"),here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "SOUTH.BRIDGE.RUN.7.DAT")))
...
#Model 1 North BTS Removed ---------------------------
asap <- read_asap3_dat(c(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "NORTH.RUN.7.ALB.BIG.DAT"),here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "SOUTH.BRIDGE.RUN.7.DAT")))
...
sel$re <- rep(c("2dar1","2dar1","none","ar1_y","none","ar1_y","none"), c(1,1,2+4,4,1,1,9))
...
temp <- prepare_wham_input(asap_alt, selectivity = sel, NAA_re = NAA_re, basic_info = basic_info, move = move, ecov = ecov,
                           age_comp = list(
                             ...
                             indices = rep(c("dir-mult","logistic-normal-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"),c(5,1,7,1,1))))
...
temp$index_names = paste0(rep(c("North_", "South_"),c(6,9)), temp$index_names)
...
temp$par$log_index_sig_scale[c(6,14)] <- log(5)
temp$map$log_index_sig_scale  <- factor(c(NA,NA,NA,NA,NA,1,NA,NA,NA,NA,NA,NA,NA,2,NA))
...
#Model 2 North Albatross Removed ---------------------------
asap <- read_asap3_dat(c(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "NORTH.RUN.7.ALB.DAT"),here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "SOUTH.BRIDGE.RUN.7.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
# sel$re <- rep(c("2dar1","2dar1","none","none","none"), c(1,1,2+4+6,1,10))
sel$re <- rep(c("2dar1","2dar1","none","ar1_y","none","ar1_y","2dar1","none"), c(1,1,2+4,4,1,1,1,9))
#ar1_y on north rec cpa
temp <- prepare_wham_input(asap_alt, selectivity = sel, NAA_re = NAA_re, basic_info = basic_info, move = move, ecov = ecov,
                           age_comp = list(
                             fleets = c("dir-mult","logistic-normal-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"), 
                             indices = rep(c("dir-mult","logistic-normal-miss0","dir-mult","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"),c(5,1,1,7,1,1))))
# indices = rep(c("dir-mult","logistic-normal-miss0","dir-mult","logistic-normal-ar1-miss0","dir-mult"),c(6,1,8,1,1))))
temp$fleet_names = paste0(rep(c("North_", "South_"),each = 2), temp$fleet_names)
temp$index_names = paste0(rep(c("North_", "South_"),c(7,9)), temp$index_names)
temp$map$trans_mu <- factor(rep(NA,length(temp$par$trans_mu)))
temp$data$selblock_pointer_fleets[] <- rep(1:4, each = length(temp$years))
temp <- wham:::set_selectivity(temp,sel)
#temp$data$agg_index_sigma[,c(1,3)] <- 5*temp$data$agg_index_sigma[,c(1,3)]
#estimate log_index_sig_scale for the rec CPA indices
temp$par$log_index_sig_scale[c(6,15)] <- log(5)
temp$map$log_index_sig_scale  <- factor(c(NA,NA,NA,NA,NA,1,NA,NA,NA,NA,NA,NA,NA,NA,2,NA))
x <- array(as.integer(temp$map$log_NAA_sigma), dim = dim(temp$par$log_NAA_sigma))
x[1,2,2:8] <- NA #allow sigmas to be different for the two regions for north pop
temp$map$log_NAA_sigma <- factor(x)
temp$par$log_NAA_sigma[1,2,2:8] <- log(0.05) #fix sigmas to be very low (~SCAA) for north population in the south
...
asap <- read_asap3_dat(c(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "NORTH.RUN.7.BIG.DAT"),here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "SOUTH.BRIDGE.RUN.7.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
# sel$re <- rep(c("2dar1","2dar1","none","none","none"), c(1,1,2+4+6,1,10))
sel$re <- rep(c("2dar1","2dar1","none","2dar1","ar1_y","none","ar1_y","none"), c(1,1,2+4,1,4,1,1,9))
#ar1_y on north rec cpa
temp <- prepare_wham_input(asap_alt, selectivity = sel, NAA_re = NAA_re, basic_info = basic_info, move = move, ecov = ecov,
                           age_comp = list(
                             fleets = c("dir-mult","logistic-normal-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"), 
                             indices = rep(c("dir-mult","logistic-normal-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"),c(6,1,7,1,1))))
# indices = rep(c("dir-mult","logistic-normal-miss0","dir-mult","logistic-normal-ar1-miss0","dir-mult"),c(6,1,8,1,1))))
temp$fleet_names = paste0(rep(c("North_", "South_"),each = 2), temp$fleet_names)
temp$index_names = paste0(rep(c("North_", "South_"),c(7,9)), temp$index_names)
temp$map$trans_mu <- factor(rep(NA,length(temp$par$trans_mu)))
...
#temp$data$agg_index_sigma[,c(1,3)] <- 5*temp$data$agg_index_sigma[,c(1,3)]
#estimate log_index_sig_scale for the rec CPA indices
temp$par$log_index_sig_scale[c(7,15)] <- log(5)
temp$map$log_index_sig_scale  <- factor(c(NA,NA,NA,NA,NA,NA,1,NA,NA,NA,NA,NA,NA,NA,2,NA))
x <- array(as.integer(temp$map$log_NAA_sigma), dim = dim(temp$par$log_NAA_sigma))
x[1,2,2:8] <- NA #allow sigmas to be different for the two regions for north pop
temp$map$log_NAA_sigma <- factor(x)
temp$par$log_NAA_sigma[1,2,2:8] <- log(0.05) #fix sigmas to be very low (~SCAA) for north population in the south
...
tfit3 <- fit_wham(temp, do.sdrep = F, do.osa = F, do.retro = F)
saveandplot(tfit3,"tfit3")
...
#Model 4 North NEAMAP Removed---------------------------
asap <- read_asap3_dat(c(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "NORTH.RUN.7.NEAMAP.DAT"),here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "SOUTH.BRIDGE.RUN.7.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
# sel$re <- rep(c("2dar1","2dar1","none","none","none"), c(1,1,2+4+6,1,10))
sel$re <- rep(c("2dar1","2dar1","none","2dar1","ar1_y","none","ar1_y","2dar1","none"), c(1,1,2+4,1,3,1,1,1,9))
#ar1_y on north rec cpa
temp <- prepare_wham_input(asap_alt, selectivity = sel, NAA_re = NAA_re, basic_info = basic_info, move = move, ecov = ecov,
                           age_comp = list(
                             fleets = c("dir-mult","logistic-normal-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"), 
...
#Model 5 MA Removed ---------------------------
asap <- read_asap3_dat(c(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "NORTH.RUN.7.MA.DAT"),here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "SOUTH.BRIDGE.RUN.7.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
#Model 6 RI Removed ---------------------------
asap <- read_asap3_dat(c(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "NORTH.RUN.7.RI.DAT"),here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "SOUTH.BRIDGE.RUN.7.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
#Model 7 CT Removed---------------------------
asap <- read_asap3_dat(c(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "NORTH.RUN.7.CT.DAT"),here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs",this_run, "SOUTH.BRIDGE.RUN.7.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("GitHub","BSB.2023.RT.Modeling","2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
# sel$re <- rep(c("2dar1","2dar1","none","none","none"), c(1,1,2+4+6,1,10))
sel$re <- rep(c("2dar1","2dar1","none","2dar1","ar1_y","none","ar1_y","2dar1","none"), c(1,1,2+4,1,4,1,1,1,9))
#ar1_y on north rec cpa
temp <- prepare_wham_input(asap_alt, selectivity = sel, NAA_re = NAA_re, basic_info = basic_info, move = move, ecov = ecov,
                           age_comp = list(
                             fleets = c("dir-mult","logistic-normal-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"), 
...
#Model 8 NY Removed ---------------------------
asap <- read_asap3_dat(c(here("2023.RT.Runs",this_run, "NORTH.RUN.7.NY.DAT"),here("2023.RT.Runs",this_run, "SOUTH.BRIDGE.RUN.7.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
...
# sel$re <- rep(c("2dar1","2dar1","none","none","none"), c(1,1,2+4+6,1,10))
sel$re <- rep(c("2dar1","2dar1","none","2dar1","ar1_y","ar1_y","2dar1","none"), c(1,1,2+4,1,4,1,1,9))
#ar1_y on north rec cpa
temp <- prepare_wham_input(asap_alt, selectivity = sel, NAA_re = NAA_re, basic_info = basic_info, move = move, ecov = ecov,
                           age_comp = list(
                             fleets = c("dir-mult","logistic-normal-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"), 
...
asap <- read_asap3_dat(c(here("2023.RT.Runs",this_run, "NORTH.BRIDGE.RUN.7.DAT"),here("2023.RT.Runs",this_run, "SOUTH.RUN.7.ALB.BIG.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
# sel$re <- rep(c("2dar1","2dar1","none","none","none"), c(1,1,2+4+6,1,10))
sel$re <- rep(c("2dar1","2dar1","none","2dar1","ar1_y","none","ar1_y","2dar1","none"), c(1,1,2+4,1,4,1,1,1,7))
#ar1_y on north rec cpa
temp <- prepare_wham_input(asap_alt, selectivity = sel, NAA_re = NAA_re, basic_info = basic_info, move = move, ecov = ecov,
                           age_comp = list(
                             fleets = c("dir-mult","logistic-normal-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"), 
                             indices = rep(c("dir-mult","logistic-normal-miss0","dir-mult","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"),c(6,1,1,5,1,1))))
# indices = rep(c("dir-mult","logistic-normal-miss0","dir-mult","logistic-normal-ar1-miss0","dir-mult"),c(6,1,8,1,1))))
temp$fleet_names = paste0(rep(c("North_", "South_"),each = 2), temp$fleet_names)
temp$index_names = paste0(rep(c("North_", "South_"),c(8,7)), temp$index_names)
temp$map$trans_mu <- factor(rep(NA,length(temp$par$trans_mu)))
temp$data$selblock_pointer_fleets[] <- rep(1:4, each = length(temp$years))
temp <- wham:::set_selectivity(temp,sel)
#temp$data$agg_index_sigma[,c(1,3)] <- 5*temp$data$agg_index_sigma[,c(1,3)]
#estimate log_index_sig_scale for the rec CPA indices
temp$par$log_index_sig_scale[c(7,15)] <- log(5)
temp$map$log_index_sig_scale  <- factor(c(NA,NA,NA,NA,NA,NA,1,NA,NA,NA,NA,NA,NA,NA,2))
x <- array(as.integer(temp$map$log_NAA_sigma), dim = dim(temp$par$log_NAA_sigma))
x[1,2,2:8] <- NA #allow sigmas to be different for the two regions for north pop
temp$map$log_NAA_sigma <- factor(x)
temp$par$log_NAA_sigma[1,2,2:8] <- log(0.05) #fix sigmas to be very low (~SCAA) for north population in the south
...
asap <- read_asap3_dat(c(here("2023.RT.Runs",this_run, "NORTH.BRIDGE.RUN.7.DAT"),here("2023.RT.Runs",this_run, "SOUTH.RUN.7.ALB.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
# sel$re <- rep(c("2dar1","2dar1","none","none","none"), c(1,1,2+4+6,1,10))
sel$re <- rep(c("2dar1","2dar1","none","2dar1","ar1_y","none","ar1_y","2dar1","none"), c(1,1,2+4,1,4,1,1,1,8))
#ar1_y on north rec cpa
temp <- prepare_wham_input(asap_alt, selectivity = sel, NAA_re = NAA_re, basic_info = basic_info, move = move, ecov = ecov,
                           age_comp = list(
                             fleets = c("dir-mult","logistic-normal-miss0","logistic-normal-ar1-miss0","logistic-normal-ar1-miss0"), 
...
asap <- read_asap3_dat(c(here("2023.RT.Runs",this_run, "NORTH.BRIDGE.RUN.7.DAT"),here("2023.RT.Runs",this_run, "SOUTH.RUN.7.BIG.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
#estimate log_index_sig_scale for the rec CPA indices
temp$par$log_index_sig_scale[c(7,16)] <- log(5)
temp$map$log_index_sig_scale  <- factor(c(NA,NA,NA,NA,NA,NA,1,NA,NA,NA,NA,NA,NA,NA,NA,2))
x <- array(as.integer(temp$map$log_NAA_sigma), dim = dim(temp$par$log_NAA_sigma))
x[1,2,2:8] <- NA #allow sigmas to be different for the two regions for north pop
temp$map$log_NAA_sigma <- factor(x)
temp$par$log_NAA_sigma[1,2,2:8] <- log(0.05) #fix sigmas to be very low (~SCAA) for north population in the south
...
tfit11 <- fit_wham(temp, do.sdrep = F, do.osa = F, do.retro = F)
saveandplot(tfit11,"tfit11")

fit11 <- fit_wham(temp, do.sdrep = T, do.osa = T, do.retro = T, do.brps = T)
...
asap <- read_asap3_dat(c(here("2023.RT.Runs",this_run, "NORTH.BRIDGE.RUN.7.DAT"),here("2023.RT.Runs",this_run, "SOUTH.RUN.7.NEAMAP.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
tfit12 <- fit_wham(temp, do.sdrep = F, do.osa = F, do.retro = F)
saveandplot(tfit12,"tfit12")

fit12 <- fit_wham(temp, do.sdrep = T, do.osa = T, do.retro = T, do.brps = T)
...
#Model 13 NJ Removed---------------------------
asap <- read_asap3_dat(c(here("2023.RT.Runs",this_run, "NORTH.BRIDGE.RUN.7.DAT"),here("2023.RT.Runs",this_run, "SOUTH.RUN.7.NJ.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
tfit13 <- fit_wham(temp, do.sdrep = F, do.osa = F, do.retro = F)
saveandplot(tfit13,"tfit13")

fit13 <- fit_wham(temp, do.sdrep = T, do.osa = T, do.retro = T, do.brps = T)
...
#Model 14 DE Removed ---------------------------
asap <- read_asap3_dat(c(here("2023.RT.Runs",this_run, "NORTH.BRIDGE.RUN.7.DAT"),here("2023.RT.Runs",this_run, "SOUTH.RUN.7.DE.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
...
tfit15 <- fit_wham(temp, do.sdrep = F, do.osa = F, do.retro = F)
saveandplot(tfit15,"tfit15")

fit15 <- fit_wham(temp, do.sdrep = T, do.osa = T, do.retro = T, do.brps = T)
...
asap <- read_asap3_dat(c(here("2023.RT.Runs",this_run, "NORTH.BRIDGE.RUN.7.DAT"),here("2023.RT.Runs",this_run, "SOUTH.RUN.7.VIMS.DAT")))
asap_alt <- change_max_Neff_fn(asap, 1000)
north_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_nmab_1959-2022.csv"))
south_bt <- read.csv(here("2023.RT.Runs","Run33","bsb_bt_temp_smab_1959-2022.csv"))
